...
Este release é uma ferramenta de comunicação fundamental ao trabalho de divulgação e difusão das novidades sobre o produto, evoluído com as inovações geradas na área de desenvolvimento do produto.
...
O time de desenvolvimento da plataforma Mangue.io, durante o período de Junho a Dezembro do ano 2023, desenvolveu  08 (oito) implementações descritas na sequência.
...
|                            |  * O segundo ícone permite visualizar o log de algum recurso, solicitando as           |
