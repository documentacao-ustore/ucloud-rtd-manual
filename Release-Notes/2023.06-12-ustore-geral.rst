...
Na sequência cada uma destas novas características são detalhadas com: objetivo, descrição, novo comportamento e localização no portal.
...
O time de desenvolvimento do portal uCloud, durante o período de Junho a Dezembro do ano 2023, desenvolveu  14 (catorze) novas implementações descritas na sequência.
   ...
   *  **uCloud Operação**:
   *  8. Termo de Responsabilidade no menu Configuração;
   *  9. Menu Recomendações;
   * 10. Menu Orquestrador.
   * **uCloud Segurança**:
   * 11. Auto Assessment no menu Assessments;
   * 12. Jornada do Gerente Admin no menu Ethical Phishing;
   * 13. Jornada do Usuário Utilizador no menu Ethical Phishing.

Na sequência cada uma destas novas características são detalhadas com: objetivo, descrição, novo comportamento, localização no portal e link de acesso ao manual de uso.
...
+----------------------------+----------------------------------------------------------------------------------------------------------------------+
|Descrição                   |Este alerta é opcional, fica a critério do usuário ativá-lo ou não.                                                   |
+----------------------------+----------------------------------------------------------------------------------------------------------------------+
...
+----------------------------+----------------------------------------------------------------------------------------------------------------------+
|Link de acesso              |https://bit.ly/barucloudmu                                                                                            |
+----------------------------+----------------------------------------------------------------------------------------------------------------------+
...
+----------------------------+----------------------------------------------------------------------------------------------------------------------+
|Link de acesso              |https://bit.ly/rcbucloumu                                                                                             |
+----------------------------+----------------------------------------------------------------------------------------------------------------------+
...
.. image:: /figuras/fig_crp/018_custo_relacional_produto_dia.png
   :alt: Dados do Relatório CRP por dia 
   :scale: 100 %
   :align: center
----
...
+----------------------------+----------------------------------------------------------------------------------------------------------------------+
|Link de acesso              |https://bit.ly/fucloudmu                                                                                              |
+----------------------------+----------------------------------------------------------------------------------------------------------------------+
...
+----------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
|Link de acesso              |https://bit.ly/rfmfucloudmu                                                                                                                                               |
+----------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
.. centered:: 8. Termo de Responsabilidade no menu Configuração
...
+----------------------------+-------------------------------------------------------------------------------------------+
|Nova classificação no portal|Prover informação sobre ações para otimizar os desvios em relação às práticas recomendadas:|
|                            |  * Limites de serviço                                                                     |
|                            |  * Segurança                                                                              |
|                            |  * Otimização de custo                                                                    |
|                            |  * Tolerância a falhas                                                                    |
...
|                            |além de obter o cenário sobre a performance dos clusters ou serviços.                       |
...
.. centered::  11. Auto Assessments no menu Assessments
...
+----------------------------+-------------------------------------------------------------------------------------------+
|Localização no portal       |https://bit.ly/aaucloudmu                                                                  | 
+----------------------------+-------------------------------------------------------------------------------------------+
...
.. centered::  12. Jornada do Gerente Admin no menu Ethical Phishing
...
.. centered:: 13. Jornada do Usuário Utilizador no menu Ethical Phishing
