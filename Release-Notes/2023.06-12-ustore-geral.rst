...
Este release da  é uma ferramenta de comunicação fundamental ao trabalho de divulgação e difusão das novidades sobre o produto, evoluído com as inovações geradas na área de desenvolvimento do produto.
...
O time de desenvolvimento da plataforma Mangue.io durante o período de Junho a Dezembro do ano 2023, desenvolveu  o total de 08 (oito) novas implementações descritas na sequência.
...
|                            |chamando de KSPM (Kubernetes Security Posture Management), que tem a finalidade de      |
...
.. figure:: /figuras/fig_mangue/notas/001_cluster health.png
   :alt:  Cluster Health
   :scale: 100 %
   :align: center
----
...
.. figure:: /figuras/fig_mangue/notas/002_cluster score.png
   :alt: Cluster Score  
   :scale: 100 %
   :align: center
----
...
+============================+========================================================================================+
|Objetivo                    |Garantir a perfeita integração e comunicação entre o mangue e um cluster RKE            |
+----------------------------+----------------------------------------------------------------------------------------+
...
|                            |* Ao clicar no primeiro ícone é mostrado o espaço de exibição dos logs.                 |
|                            |* O segundo ícone permite visualizar o log de algum recurso, solicitando as informações |
|                            |demonstradas a seguir:
+----------------------------+----------------------------------------------------------------------------------------+


.. figure:: /figuras/fig_mangue/notas/003_coleta logs distribuídos.png
...
.. figure:: /figuras/fig_mangue/notas/004_recomendação de nodes.png
...
.. figure:: /figuras/fig_mangue/notas/005_recursos alocados.png
...
.. figure:: /figuras/fig_mangue/notas/006_workloads yaml.png
   :alt: Workloads yaml  
   :scale: 100 %
   :align: center
----
...
|                            |e consistentes.                                                                         |
+----------------------------+----------------------------------------------------------------------------------------+
|Novo comportamento do portal|Editar em yaml para recursos como deployment, facilitando a forma de visualização e     |
|                            |possibilitando a edição como json e yaml.                                               |
+----------------------------+----------------------------------------------------------------------------------------+
|Localização no portal       |Financeiro > Recomendações                                                              |
+----------------------------+----------------------------------------------------------------------------------------+


.. figure:: /figuras/fig_mangue/notas/007_recomendações sem outliers.png
...
O time de desenvolvimento da plataforma uSavings durante o período de Junho a Dezembro do ano 2023, desenvolveu  13 (treze) novas implementações descritas na sequência.
...
+============================+================================================================================================+
|Objetivo                    |Listar instâncias EC2 conjuntamente as recomendações de savings                                 |
+----------------------------+------------------------------------------------------------------------------------------------+
...
.. centered:: ElasticCache

----

+----------------------------+----------------------------------------------------------------------------------------------+
|Feature                     |ElasticCache                                                                                  |
+============================+==============================================================================================+
|Objetivo                    |Apresentar a listagem de clusters ElastiCache, em conjunto com as recomendações.              |
+----------------------------+----------------------------------------------------------------------------------------------+
|Novo comportamento no portal|A partir desta feature, são feitas as recomendações sobre os clusters do ElasticCache. Como   |
...
Plataforma uCloud Billing

----

O time de desenvolvimento da plataforma uCloud, durante o período de Junho a Dezembro do ano 2023, desenvolveu  xx (xxxx) novas implementações descritas na sequência.
...
.. centered:: Integração com o sistema financeiro EBT/ODIN
...
.. centered:: Menu Segurança: Tickets
...
.. centered:: Menu Segurança: Assessments > Auto Assessment
...
.. centered:: Menu Segurança: Ethical Phishing > Acesso dos usuários: Gerente Admin e Utilizador
