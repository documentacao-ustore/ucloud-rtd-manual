...
+============================+===========================================================================================+
|Objetivo                    | Reporta dados de consumo para a Embratel (Odin)                                           |
+----------------------------+-------------------------------------------------------------------------------------------+
|Descrição                   | Seção responsável pela integração, visualização e envio de dados de consumo para o        |
|                            | serviço de faturamento da Embratel (Odin).                                                |                                             
+----------------------------+-------------------------------------------------------------------------------------------+
|Novo comportamento no portal| Sua principal função é o envio de dados para a plataforma da Embratel (Odin), nenhum      |                                                                             
+----------------------------+-------------------------------------------------------------------------------------------+
...
.. image:: /figuras/fig_pmc_odin/005_contrato_selecionado_tela.png
...
+============================+===========================================================================================+
|Objetivo                    | Sondar e identificar de maneira ética os potenciais usuários que necessitam de            |
|                            | conscientização sobre os perigos dos ambientes virtuais                                   |
+----------------------------+-------------------------------------------------------------------------------------------+
...
|Novo comportamento no portal| Proporciona realizar campanhas éticas de envio de e-mails, com o objetivo de identificar  |
|                            | os usuários que desconhecem os riscos e ameaças desta modalidade de cibercrime.           |                                              
